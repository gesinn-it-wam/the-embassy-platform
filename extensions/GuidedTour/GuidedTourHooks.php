...
class GuidedTourHooks {
	...
	*/
	...
	public static function addTour( $out, $tourName ) {
		...
		// Line above blocks including of tour.js in Special:Preferences
		// For our case we set this to true as default
		// Check https://www2.semantic-apps.net/wiki/Issue:1328
		$isUserJsAllowed = true;
