 ...
 * @ingroup Skins
 */
class CustomNavbarHorizontal extends Component {
	...
	private function wrapDropdownMenu( $tail ) {
		...
		return
			...
			'<div class="container"><div class="row">' .IdRegistry::getRegistry()->element( 'div',
				['class'=>'collapse navbar-collapse',	'id'=> $id ], $tail, $this->indent() ) . ' </div></div>';
	}
